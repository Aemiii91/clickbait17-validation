(function () {
	...
	function fetchQueue(urls) {
	  ...
	  urls.forEach(function (url, index) {
	    queue.push(fetch(url).then(function (response) {
	...
	function getItemData(index) {
	  ...
	  switch (score) {
	    case 0:
	      item.truth.text = "Not click baiting";
	      break;

	    case 1:
	      item.truth.text = "Slightly click baiting";
	      break;

	    case 2:
	      item.truth.text = "Considerably click baiting";
	      break;

	    case 3:
	      item.truth.text = "Heavily click baiting";
	      break;
	  }
